        ...
        <div class="nazar" >
            ...
            <div class="col-lg-6">
                <ul>
                    ...
                    <li class="liFont">
                        <p><fmt:message key="driver.phone"/>: <c:out value="${sessionScope.loginedUser.phoneNumber}"/></p>
                    </li>

                    <li class="liFont">
                        <p><fmt:message key="driver.role"/>: <c:out value="${sessionScope.loginedUser.role.name()}"/></p>
                    </li>
