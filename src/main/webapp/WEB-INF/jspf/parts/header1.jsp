...
<%--&lt;%&ndash;            <div class="lang_block">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <ul id="lang">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <li class="lang-item lang-item-5">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <a href="?locale=ru">ru</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <li class="lang-item lang-item-5">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <a href="?locale=en">en</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--        </div>--%>
